...
Plugin URI: https://wpcodefactory.com/item/woocommerce-call-for-price-plugin/
...
final class Alg_Woocommerce_Call_For_Price {
	 ...
	 * @access  public
	 * @version 3.0.0
	 * @todo    labels per product (and per variation)
	 */
	...
	function action_links( $links ) {
		...
		if ( 'woocommerce-call-for-price.php' === basename( __FILE__ ) ) {
			$custom_links[] = '<a target="_blank" href="https://wpcodefactory.com/item/woocommerce-call-for-price-plugin/">' . __( 'Unlock All', 'woocommerce-call-for-price' ) . '</a>';
		}
	...
	private function includes() {
		...
		$settings[] = require_once( 'includes/admin/class-wc-call-for-price-settings-product-types.php' );
